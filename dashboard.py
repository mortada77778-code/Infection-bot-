...
<h2 class="text-3xl font-bold gold">
مرحباً بك يا {username}
</h2>

<p class="text-gray-500 text-sm mt-2">
مجلس الإدارة السحرية • لوحة التحكم الرئيسية
</p>
...
✨ مركز الإدارة السحرية
</div>

<p class="text-gray-400 leading-8">

مرحباً بك في مركز التحكم.
من هنا يمكن إدارة أنظمة المملكة السحرية
ومتابعة المبارزات والفعاليات وسجلات الطلاب.
